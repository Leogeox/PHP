...
--
-- Host: localhost:3306
-- Generation Time: Nov 26, 2025 at 11:05 AM
...
CREATE TABLE `activities` (
  ...
  `places_disponibles` varchar(200) DEFAULT NULL,
...
ALTER TABLE `reservations`
  ...
  ADD CONSTRAINT `fk_reservations_user` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
COMMIT;
